...
<head>
    ...
    <title>Jabberwock-Isle Trading Post</title>
    ...
    * {
    ...
    #pageTitle {
        height: 50px;
        background-image: url("jabberwocklogo.png");
    ...
    .warningMessageDropdown, .warningMessageDropdown:hover, .warningMessageDropdown:active, .successMessageDropdown:focus {
        color: #856404;
            ...
            <?php
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <div title="<?php echo $row['studentname']; ?>" class="sidebarItem<?php if ((basename($_SERVER['SCRIPT_NAME']) == "student.php") && ($_GET['sid'] == $row['studentid'])) { echo " active"; } ?>">
                            <a class="sidebarLink" href="student.php?sid=<?php echo $row['studentid']; ?>"><img class="sidebarIcon" src="studentsprites/originalsprites/<?php echo $row['studentsprite']; ?>"> <p class="sidebarText"><?php echo $row['studentname']; ?></p></a>
                        </div>
            <?php   }
                    echo "<div class='sidebarDivider'></div>";
                } ?>
            <div title="Students" class="sidebarItem<?php if (basename($_SERVER['SCRIPT_NAME']) == "student.php") { echo " active"; } ?>">
                <a class="sidebarLink" href="student.php"><i class="fas fa-user-graduate sidebarIcon"></i> <p class="sidebarText">Students</p></a>
            </div>
                                ...
                                <li class="dropdown-item <?php echo $messagerow['type']; ?>MessageDropdown">
                                    <div id="messageid<?php echo $messagerow['messageid']; ?>" class="horizontalFlex">
                                        <div class="message-textbody">
                                            <div>
                                                <?php
                                                    if (strlen($messagerow['messagetext']) > 50) {
                                                        echo substr($messagerow['messagetext'],0,50)."...";
                                                    } else {
                                                        echo $messagerow['messagetext'];
                                                    }
                                                ?>
                                            </div>
