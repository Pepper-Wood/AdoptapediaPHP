...
$banknote = mysqli_real_escape_string($conn, $_POST['note']);
...
$transactionhistorysql = "INSERT INTO `banktransactions`(`transactionid`, `timestamp`, `userid`, `studentid`, `monocoins`, `battleForTheBank`, `note`) VALUES (".$maxTransLogID.",".$unixtimestamp.",".$_POST['userid'].",".$studentid.",".$_POST['monocoins'].",".$_POST['battleForTheBank'].",'".$banknote."');";
if ($debug) {
