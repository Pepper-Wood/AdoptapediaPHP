...
<div class="container-fluid">
    ...
    if (isset($_GET['iid'])) {
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                echo "<tr><td>".$row['quantity']."</td><td><a target='_blank' href='https://jabberwock-isle.com/inventories.php?uid=".$row['ownerid']."'>".$row['username']."</a></td></tr>";
            }
        }
        echo "</tbody></table>";
    }
...
$("#scavengerItem").change(function() {
    window.location.href = "https://jabberwock-isle.com/itemsearch.php?iid=" + $(this).val();
});
</script>
