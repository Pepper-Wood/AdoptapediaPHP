...
function getMinecraftClassPoints($classType) {
    ...
    if ($teamType == 'halloween') {
        ...
        $totalpointsquery .= 'reindeerGames';
    }
...
function getBankClassPoints($classType) {
    global $timestampQuery, $teamType, $conn;
    $totalpointsquery = "SELECT SUM(banktransactions.monocoins) AS totalcoins FROM banktransactions LEFT JOIN students ON banktransactions.studentid=students.studentid WHERE banktransactions.battleForTheBank=1 AND ";
    if ($teamType == 'halloween') {
        $totalpointsquery .= 'halloweenTeam';
    } else if ($teamType == 'classwars') {
        $totalpointsquery .= 'class';
...
function printBankClassStudents($classType) {
    global $timestampQuery, $teamType, $conn;
    $sql = "SELECT DISTINCT studentsprite FROM banktransactions LEFT JOIN students ON banktransactions.studentid=students.studentid WHERE banktransactions.battleForTheBank=1 AND ";
    if ($teamType == 'halloween') {
        $sql .= 'halloweenTeam';
    } else if ($teamType == 'classwars') {
        $sql .= 'class';
...
function printMinecraftStudentRankings() {
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<div class='horizontalFlex'><div class='studentRankSprite'><img src='studentsprites/originalsprites/".$row['studentsprite']."'></div>";
...
if ($teamType == 'classwars') {
    ...
    array_push($minecraftclasspoints, getMinecraftClassPoints("Dasher"));
    array_push($minecraftclassavgpoints, round($minecraftclasspoints[0]/$teamCounts["Dasher"],2));
    array_push($minecraftclasspoints, getMinecraftClassPoints("Dancer"));
    array_push($minecraftclassavgpoints, round($minecraftclasspoints[1]/$teamCounts["Dancer"],2));
    array_push($minecraftclasspoints, getMinecraftClassPoints("Prancer"));
    array_push($minecraftclassavgpoints, round($minecraftclasspoints[2]/$teamCounts["Prancer"],2));
    array_push($minecraftclasspoints, getMinecraftClassPoints("Vixen"));
    array_push($minecraftclassavgpoints, round($minecraftclasspoints[3]/$teamCounts["Vixen"],2));
    array_push($minecraftclasspoints, getMinecraftClassPoints("Comet"));
    array_push($minecraftclassavgpoints, round($minecraftclasspoints[4]/$teamCounts["Comet"],2));
    array_push($minecraftclasspoints, getMinecraftClassPoints("Cupid"));
    array_push($minecraftclassavgpoints, round($minecraftclasspoints[5]/$teamCounts["Cupid"],2));
    array_push($minecraftclasspoints, getMinecraftClassPoints("Donner"));
    array_push($minecraftclassavgpoints, round($minecraftclasspoints[6]/$teamCounts["Donner"],2));
    array_push($minecraftclasspoints, getMinecraftClassPoints("Blitzen"));
    array_push($minecraftclassavgpoints, round($minecraftclasspoints[7]/$teamCounts["Blitzen"],2));
    array_push($minecraftclasspoints, getMinecraftClassPoints("Rudolph"));
    array_push($minecraftclassavgpoints, round($minecraftclasspoints[8]/$teamCounts["Rudolph"],2));
    array_push($bankclasspoints, getBankClassPoints("Dasher"));
    array_push($bankclassavgpoints, round($bankclasspoints[0]/$teamCounts["Dasher"],2));
    array_push($bankclasspoints, getBankClassPoints("Dancer"));
    array_push($bankclassavgpoints, round($bankclasspoints[1]/$teamCounts["Dancer"],2));
    array_push($bankclasspoints, getBankClassPoints("Prancer"));
    array_push($bankclassavgpoints, round($bankclasspoints[2]/$teamCounts["Prancer"],2));
    array_push($bankclasspoints, getBankClassPoints("Vixen"));
    array_push($bankclassavgpoints, round($bankclasspoints[3]/$teamCounts["Vixen"],2));
    array_push($bankclasspoints, getBankClassPoints("Comet"));
    array_push($bankclassavgpoints, round($bankclasspoints[4]/$teamCounts["Comet"],2));
    array_push($bankclasspoints, getBankClassPoints("Cupid"));
    array_push($bankclassavgpoints, round($bankclasspoints[5]/$teamCounts["Cupid"],2));
    array_push($bankclasspoints, getBankClassPoints("Donner"));
    array_push($bankclassavgpoints, round($bankclasspoints[6]/$teamCounts["Donner"],2));
    array_push($bankclasspoints, getBankClassPoints("Blitzen"));
    array_push($bankclassavgpoints, round($bankclasspoints[7]/$teamCounts["Blitzen"],2));
    array_push($bankclasspoints, getBankClassPoints("Rudolph"));
    array_push($bankclassavgpoints, round($bankclasspoints[8]/$teamCounts["Rudolph"],2));
}
...
<div class="container-fluid">
    ...
    Teams: <select id="teamTypeSelect">
        ...
        <option value='reindeer' <?php if ($teamType == "reindeer") { echo "selected"; } ?>>Reindeer Games</option>
    </select>
