...
$("#decrement10Monocoins").click(function() {
    var addQuantity = parseInt($("#monocoinsQuantity").text());
    $("#monocoinsQuantity").text(addQuantity-10);
});
$("#decrement1Monocoins").click(function() {
    var addQuantity = parseInt($("#monocoinsQuantity").text());
    $("#monocoinsQuantity").text(addQuantity-1);
});
$("#increment1Monocoins").click(function() {
    var addQuantity = parseInt($("#monocoinsQuantity").text());
    $("#monocoinsQuantity").text(addQuantity+1);
});
$("#increment10Monocoins").click(function() {
    var addQuantity = parseInt($("#monocoinsQuantity").text());
    $("#monocoinsQuantity").text(addQuantity+10);
});
$("#giveMonocoins").click(function() {
    $.post("giveMonocoins.php", {studentid: $("#monocoinsStudent").val(), monocoins: parseInt($("#monocoinsQuantity").text()), note: $("#monocoinsNote").val()}, function(result) {
        location.reload();
    });
});
</script>
