                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <div title="<?php echo $row['studentname']; ?>" class="sidebarItem<?php if ((basename($_SERVER['SCRIPT_NAME']) == "student.php") && ($_GET['sid'] == $row['studentid'])) { echo " active"; } ?>">
                            <a class="sidebarLink" href="student.php?sid=<?php echo $row['studentid']; ?>"><img class="sidebarIcon" src="<?php echo $row['studentsprite']; ?>"> <p class="sidebarText"><?php echo $row['studentname']; ?></p></a>
                        </div>
            <?php   }
